...
abstract class Kohana_Controller {
    ...
    /**
     * Having a construct in this place force you to have a constrauct in your child controller
     * Since not all the controllers need a constructor and request and response are public..
     * there's no reason to inject it here.
     * remove it
     */
